...
% ---
\titulo{Modelagem matemática}
\autor{Matheus Paolo dos Anjos Mour\~{a}o \\ Paulo Chaves dos Santos J\'{u}nior}
...
\tipotrabalho{Solucionário}
% O preambulo deve conter o tipo do trabalho, o objetivo,
% o nome da institui\c{c}\~{a}o e a \'{a}rea de concentra\c{c}\~{a}o
\preambulo{Resoluções dos problemas referentes a modelagem matemática, entregue para a composi\c{c}\~{a}o parcial da nota da N1.
Orientador : Marcos Fabiano Firbida Eduardo}
% ---
