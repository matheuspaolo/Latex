...
\begin{description}
	...
	\end{minipage}}
	\item[b)] A forma de onda, como mostrado na \autoref{imagem2 - birimba} é de um sinal retificado de onda completa, com tensão pico de 10,6V e tensão eficaz de 6.95V RMS.\\
	...
	\centerline{\begin{minipage}[c]{\textwidth}
			...
			\includegraphics[width=1\textwidth]{Imagens/R1P3Im1.png}
			\legend{Fonte: \cite{Osciloscopio}}
			\label{}
	\end{minipage}}
...
\begin{description}
	...
	\centerline{\begin{minipage}[c]{\textwidth}
			...
			\includegraphics[width=1\textwidth]{Imagens/R3P3Im2.png}
			\legend{Fonte: \cite{Osciloscopio}}
			\label{}
	\end{minipage}}
...
\centerline{\begin{minipage}[c]{\textwidth}
		...
		\includegraphics[width=1\textwidth]{Imagens/R4PUIm1.png}
...
\centerline{\begin{minipage}[c]{\textwidth}
		...
		\includegraphics[width=0.3\textwidth]{Imagens/R4PUIm2.png}
