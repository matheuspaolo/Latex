...
\centering
\noindent
        \captionof{figure}{Simbologias de transformadores}
		\includegraphics[width=0.7\textwidth]{Imagens/Desenvolvimento-Imagem1.jpg}
		\legend{Fonte:\cite{Desenvol1/3}}
		\label{fig:image11}
 \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{Transformador com N\'{u}cleo de Ferrite}
		\includegraphics[width=0.3\textwidth]{Imagens/Desenvolvimento-Imagem2.png}
		\legend{Fonte:\cite{Desenvol2}}
		\label{fig:image11}
 \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{Transformador Monof\'{a}sico Simples }
...
\centering
\noindent
        \captionof{figure}{Principio de funcionamento do transformador el\'{e}trico}
		\includegraphics[width=0.5\textwidth]{Imagens/Desenvolvimento-Imagem4.jpg}
		\legend{Fonte:\cite{Desenvol3}}
		\label{fig:image11}
 \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{Caracter\'{\i}sticas construtivas de um transformador}
		\includegraphics[width=0.5\textwidth]{Imagens/Desenvolvimento-Imagem5.png}
		\legend{Fonte:\cite{Desenvol4}}
		\label{fig:image11}
 \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{A figura 5a traz o diagrama esquem\'{a}tico deste circuito com uma carga resistiva e a figura 5b as formas de onda em cada elemento.}
		\includegraphics[width=0.5\textwidth]{Imagens/Desenvolvimento-Imagem6.jpg}
		\legend{Fonte:\cite{Desenvol6/8/9/11/12}}
		\label{fig:image11}
 \end{minipage}}
...
\begin{tabular}{@{}|c|c|@{}}
\toprule
Corrente secund\'{a}ria             & $I_{2}= \dfrac{V_{max}}{R_L}$                                \\ \midrule
Tens\~{a}o m\'{e}dia na carga           & $V_{med}= \dfrac{V_{max}}{\pi}$                              \\ \midrule
Corrente m\'{e}dia na carga         & $I_{cc}= \dfrac{I_{max}}{\pi}=\dfrac{V_{m ax}}{R_L\cdot\pi}$ \\ \midrule
Tens\~{a}o inversa m\'{e}dia no diodo   & $V_{d_{med}}= - \dfrac{V_{max}}{\pi}$                        \\ \midrule
Tens\~{a}o de pico inversa no diodo & $V_{max}$                                                    \\ \midrule
Corrente m\'{e}dia no diodo         & $I_{cc}$                                                     \\ \bottomrule
\end{tabular}
  \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{Retificador de onda completa em ponte. }
...
\toprule
Corrente secund\'{a}ria             & $I_{2}= \dfrac{V_{max}}{R_L}$                                  \\ \midrule
Tens\~{a}o m\'{e}dia na carga           & $V_{med}= \dfrac{2V_{max}}{\pi}$                               \\ \midrule
Corrente m\'{e}dia na carga         & $I_{cc}= \dfrac{2I_{max}}{\pi}=\dfrac{2V_{m ax}}{R_L\cdot\pi}$ \\ \midrule
Tens\~{a}o eficaz na carga          & $V_{rms}=\dfrac{V_{max}}{\sqrt{2}}$                            \\ \midrule
Corrente eficaz na carga        & $I_{rms}=\dfrac{I_{max}}{\sqrt{2}}$                            \\ \midrule
Tens\~{a}o inversa m\'{e}dia no diodo   & $V_{d_{med}}= - \dfrac{V_{max}}{\pi}$                          \\ \midrule
Tens\~{a}o de pico inversa no diodo & $V_{max}$                                                      \\ \midrule
Corrente m\'{e}dia no diodo         & $\dfrac{I_{cc}}{2}$                                            \\ \bottomrule
\end{tabular}
  \end{minipage}}
...
\centering
\noindent
        \captionof{figure}{Retificador de onda completa com trafo de deriva\c{c}\~{a}o central.}
...
Tens\~{a}o m\'{e}dia na carga           & $V_{med}= \dfrac{2V_{max}}{\pi}$                               \\ \midrule
Corrente m\'{e}dia na carga         & $I_{cc}= \dfrac{2I_{max}}{\pi}=\dfrac{2V_{m ax}}{R_L\cdot\pi}$ \\ \midrule
Tens\~{a}o inversa m\'{e}dia no diodo   & $V_{d_{med}}= - \dfrac{2V_{max}}{\pi}$                         \\ \midrule
Tens\~{a}o de pico inversa no diodo & $2V_{max}$                                                     \\ \midrule
Corrente m\'{e}dia no diodo         & $\dfrac{I_{cc}}{2}$                                            \\ \bottomrule
\end{tabular}
  \end{minipage}} 